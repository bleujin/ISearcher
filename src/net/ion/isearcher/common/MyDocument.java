...
import static net.ion.isearcher.common.IKeywordField.ISBody;
import static net.ion.isearcher.common.IKeywordField.ISCollectorName;
import static net.ion.isearcher.common.IKeywordField.ISEventName;
import static net.ion.isearcher.common.IKeywordField.ISEventType;
import static net.ion.isearcher.common.IKeywordField.ISKey;
import static net.ion.isearcher.common.IKeywordField.KEYWORD_FIELD;
...
public final class MyDocument implements Serializable {
	...
	public static MyDocument newDocument(CollectorEvent event, String name, String docId) throws IOException {
		...
		doc.add(new Field(DocumentHandler.TIMESTAMP, String.valueOf(System.currentTimeMillis()), Store.YES, Index.NOT_ANALYZED)) ;
	...
	public String getIndexedDay(){
		return  DateUtil.timeMilliesToDay(Long.parseLong(get(DocumentHandler.TIMESTAMP))) ;
	}
...
//	}
	...
	public String getIdValue() {
		...
		return get(ICollectorEvent.ISKey);
	}
	...
	public String getISKey(){
		return getFieldable(ISKey).stringValue() ;
	}
