...
import net.ion.crawler.util.FileUtil;
import net.ion.crawler.util.UriFileSystemMapperUtil;
...
public class DownloadHelper extends HttpClientWrapper {
	...
	public int download(String uri, String filename, long ifModifiedSince) {
		...
		request.addHeader(HeaderConstant.HEADER_USER_AGENT, SimpleHttpClientParser.USER_AGENT);
