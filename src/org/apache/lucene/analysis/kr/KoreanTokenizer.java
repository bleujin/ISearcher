...
public class KoreanTokenizer extends Tokenizer {
	...
	private int maxTokenLength = DStandardAnalyzer.DEFAULT_MAX_TOKEN_LENGTH;
	...
	/**
	 * Creates a new instance of the {@link org.apache.lucene.analysis.standard.StandardTokenizer}. Attaches the <code>input</code> to the newly created JFlex scanner.
	 * 
	 * @param input
	 *            The input reader
	 * 
