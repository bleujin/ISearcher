...
public class Autosuggest {
	...
	public static Analyzer getAnalyzer() {
		...
		Analyzer autosuggestAnalyzer = new Analyzer() {
			...
			final String[] stopWords = { "a", "an", "and", "are", "as", "at", "be", "but", "by", "for", "if", "in", "into", "is", "it", "no", "not", "of", "on", "or", "s", "such", "t", "that", "the", "their", "then", "there", "these", "they", "this", "to", "was", "will", "with" };
	 ...
	 * 
	 * @param indexDir
	 *            Pass the directory where the index is made This uses the default field
	 * @return
	 */
	 ...
	 * 
	 * @param indexDir
	 *            Pass the directory where the index is made
	 * @param fieldName
	 *            Uses the field to build the index
	 * @return
	 */
	...
	public boolean buildSuggestor(Directory directory, String fieldName) {
		...
		try {
			...
			if (terms == null)
				return false;
			suggestor.build(new LuceneDictionary(reader, fieldName));
