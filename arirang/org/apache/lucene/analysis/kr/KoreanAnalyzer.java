...
public class KoreanAnalyzer extends StopwordAnalyzerBase {
	...
	/**
	 * Specifies whether deprecated acronyms should be replaced with HOST type. See {@linkplain "https://issues.apache.org/jira/browse/LUCENE-1068"}
	 */
	...
	protected TokenStreamComponents createComponents(final String fieldName, final Reader reader) {
		...
		final KoreanTokenizer src = new KoreanTokenizer(getVersion(), reader);
